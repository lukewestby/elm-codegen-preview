...
var _user$project$Classes$class = function (_) {
	return _.$class;
}(
	_rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(''));
var _user$project$Classes$Button = {ctor: 'Button'};
var _user$project$Classes$Editors = {ctor: 'Editors'};
var _user$project$Classes$Container = {ctor: 'Container'};

var _user$project$Main$defaultSourceCode = 'module Main exposing (..)\n\nimport Html exposing (..)\n\n\nmain : Html msg\nmain =\n  text \"Hello world!\"\n  ';
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {isProcessing: a, compilationFailed: b, compilationResult: c, sourceCode: d};
	});
var _user$project$Main$initialModel = A4(_user$project$Main$Model, false, false, _elm_lang$core$Maybe$Nothing, _user$project$Main$defaultSourceCode);
var _user$project$Main$CompilationFailure = {ctor: 'CompilationFailure'};
var _user$project$Main$CompilationSuccess = function (a) {
	return {ctor: 'CompilationSuccess', _0: a};
};
var _user$project$Main$compileCode = function (source) {
	...
	return A3(
		...
		_elm_lang$core$Basics$always(_user$project$Main$CompilationFailure),
		_user$project$Main$CompilationSuccess,
		A2(
			_elm_lang$core$Task$map,
			function (_) {
				return _.data;
			...
			A3(
				...
				A2(
					...
					A3(
						...
						'Content-Type',
						'application/json',
						_lukewestby$elm_http_builder$HttpBuilder$post('https://ecaas.herokuapp.com/compile'))))));
};
var _user$project$Main$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'UpdateSourceCode':
				return {
					ctor: '_Tuple2',
			...
			case 'CompilationStart':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isProcessing: true, compilationFailed: false}),
					_1: _user$project$Main$compileCode(model.sourceCode)
				};
			case 'CompilationSuccess':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							isProcessing: false,
							compilationResult: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isProcessing: false, compilationResult: _elm_lang$core$Maybe$Nothing, compilationFailed: true}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$CompilationStart = {ctor: 'CompilationStart'};
var _user$project$Main$UpdateSourceCode = function (a) {
	return {ctor: 'UpdateSourceCode', _0: a};
};
var _user$project$Main$view = function (model) {
	var compileButtonText = model.isProcessing ? 'Compiling...' : (model.compilationFailed ? 'The compilation server failed 😕' : 'Compile');
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Classes$class(
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Classes$Container]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$html$Html_Attributes$attribute, 'mode', 'ace/mode/elm'),
								A2(_elm_lang$html$Html_Attributes$attribute, 'theme', 'ace/theme/monokai'),
								A2(_elm_lang$html$Html_Attributes$attribute, 'value', model.sourceCode),
								A2(_elm_lang$html$Html_Attributes$attribute, 'softtabs', 'true'),
								A2(_elm_lang$html$Html_Attributes$attribute, 'tabsize', '2'),
								A2(
								_elm_lang$html$Html_Events$on,
								'change',
								A2(
									_elm_lang$core$Json_Decode$map,
									_user$project$Main$UpdateSourceCode,
									A2(
										_elm_lang$core$Json_Decode$at,
										_elm_lang$core$Native_List.fromArray(
											['target', 'value']),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$Main$defaultSourceCode)
							])),
						A3(
						_elm_lang$html$Html$node,
						'juicy-ace-editor',
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$html$Html_Attributes$attribute, 'mode', 'ace/mode/javascript'),
								A2(_elm_lang$html$Html_Attributes$attribute, 'theme', 'ace/theme/monokai'),
								A2(
								_elm_lang$html$Html_Attributes$attribute,
								'value',
								A2(_elm_lang$core$Maybe$withDefault, '', model.compilationResult)),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$CompilationStart),
								_elm_lang$html$Html_Attributes$disabled(model.isProcessing)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(compileButtonText)
							]))
					]))
			]));
};
