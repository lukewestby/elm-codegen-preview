...
Elm.Classes = Elm.Classes || {};
Elm.Classes.make = function (_elm) {
   "use strict";
   _elm.Classes = _elm.Classes || {};
   if (_elm.Classes.values) return _elm.Classes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Classes.values = {_op: _op,$class: $class,Container: Container,Editors: Editors,Button: Button};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var compileCode = function (source) {
      ...
      $Task.onError,
      function (_p0) {
         return $Task.succeed(A2($Basics.always,CompilationFailure,_p0));
      },
      A2($Task.map,
      function (_p1) {
         return CompilationSuccess(function (_) {    return _.data;}(_p1));
      },
      A3($Http$Extra.send,
   ...
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "UpdateSourceCode": return {ctor: "_Tuple2",_0: _U.update(model,{sourceCode: _p2._0}),_1: $Effects.none};
         ...
         case "CompilationSuccess": return {ctor: "_Tuple2"
                                           ,_0: _U.update(model,{isProcessing: false,compilationResult: $Maybe.Just(_p2._0)})
                                           ,_1: $Effects.none};
   ...
   var view = F2(function (address,model) {
      ...
      return A2($Html.div,
      _U.list([$Classes.$class(_U.list([$Classes.Container]))]),
      _U.list([A2($Html.div,
              _U.list([$Classes.$class(_U.list([$Classes.Editors]))]),
              _U.list([A3($Html.node,
                      ...
                      _U.list([A2($Html$Attributes.attribute,"mode","ace/mode/elm")
                              ...
                              ,A2($Html$Attributes.attribute,"softtabs","true")
                              ,A2($Html$Attributes.attribute,"tabsize","2")
                              ,A3($Html$Events.on,
                              "change",
                              $Html$Events.targetValue,
                              function (_p3) {
                                 return A2($Signal.message,address,UpdateSourceCode(_p3));
                              })]),
              ...
              ,A2($Html.div,
              _U.list([$Classes.$class(_U.list([$Classes.Button]))]),
   ...
   function (v) {
      return {isProcessing: v.isProcessing
             ,compilationFailed: v.compilationFailed
             ,compilationResult: v.compilationResult.ctor === "Nothing" ? null : v.compilationResult._0
             ,sourceCode: v.sourceCode};
   },
   A2($Signal.map,$Debug.log("model"),app.model));
   var main = app.html;
